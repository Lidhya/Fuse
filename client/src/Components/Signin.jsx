    ...
    <div className=" relative w-full max-w-md h-full md:h-auto bg-black lg:-mr-96">
        ...
        <div className=" py-6 px-6 lg:px-8 flex-1">
                ...
                <form className="space-y-6" action="#">
                    ...
                    <Link  to={'/'}><button className="w-full mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button></Link>
