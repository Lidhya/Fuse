...
function News() {
    ...
    return (
        <div className='m-3 flex flex-col justify-around '>
            <div className='w-40'>
                <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Choose a country</label>
                <select id="countries" onChange={(e) => setCountry(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div className='flex flex-wrap justify-center gap-10 mt-5'>
                {articles.length ? articles.map((article, index) => (
                    ...
                    <div className="max-w-sm max-h-sm bg-white rounded-lg border border-gray-200 shadow-md ">
                        ...
                        <div className="p-5">
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Oops! {error}</h5>
                            </a>
                            <p className="mb-3 font-normal text-gray-700 ">Something went wrong, check your internet connection</p>
                        </div>
                    </div>
                }
