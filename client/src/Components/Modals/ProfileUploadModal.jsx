...
function ProfileUploadModal({
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl  text-purple-700 font-thin mb-3">
      ...
      <div className="flex justify-between items-center my-2 mx-2 ">
        ...
        <button
          ...
          className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-xl text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Upload
        </button>
      </div>
