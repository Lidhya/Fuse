          ...
          >
            <div className=" flex flex-wrap justify-between items-center p-2.5">
              ...
              {currentUser?.followings?.includes(user?._id) ? (
                <button
                  onClick={(e) => handleUnfollow(e, user._id, user.fname)}
                  className="ml-4 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 "
                >
                  Following
                </button>
              ) : (
