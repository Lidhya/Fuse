...
<nav class="bg-white px-2 sm:px-4 py-1 dark:bg-gray-900 drop-shadow-md ">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
  <a href="https://flowbite.com/" class="flex items-center">
      <span class="self-center text-3xl font-extrabold whitespace-nowrap text-yellow-500">FUSE<span className='text-purple-700'>.</span></span>

  </a>
  <div class="flex md:order-2">
    <button type="button" data-collapse-toggle="navbar-search" onClick={handleSearchClick} aria-controls="navbar-search" aria-expanded="false" class="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
      <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
      <span class="sr-only">Search</span>
    </button>
    <div class="hidden relative md:block" id='navbar-search'>
    ...
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-hamburger">
      ...
      <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:gap-6 md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="#" class="block py-2 pr-4 pl-3 text-purple-700 hover:text-white rounded md:bg-transparent md:text-purple-700 md:p-0 dark:text-purple-700 " aria-current="page"><HomeOutlinedIcon /><span className='md:hidden pl-3'>Home</span></a>
        </li>
        <li>
          <a href="#" class="block py-2 pr-4 pl-3 text-purple-700 hover:text-white rounded md:hover:bg-transparent md:hover:text-purple-700 md:p-0 md:dark:hover:text-white dark:text-purple-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"><TextsmsOutlinedIcon/><span className='md:hidden pl-3'>Message</span></a>
        </li>
        <li>
