...
function Message({ message, own, user }) {
  ...
  return (
    <div
      className={
        own ? "flex flex-col mt-5 items-end m-3" : "flex flex-col mt-5 m-3"
      }
    >
      <div className="flex">
        <img
        ...
        <p
          className={
            own
              ? "p-2.5 rounded-2xl bg-gray-300 text-black max-w-xs"
              : "p-2.5 rounded-2xl bg-purple-700 text-white max-w-xs"
          }
        >
          {text}
        </p>
